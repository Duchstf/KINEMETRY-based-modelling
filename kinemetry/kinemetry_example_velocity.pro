...
; V2.0. DK, Potsdam, change for kinemetry on SAURON velocities only
;           (for SAURON velocity dispersions see 
;           kinemetry_example_sigma)
;###############################################################

PRO kinemetry_example_velocity

;
; read in all data
;
file = '/Users/duc/Research/Rotation-Curve/Practice/test-KINEMETRY/kinemetry/NGC2974_SAURON_kinematics.dat'
...
ploterror, rad, pa, er_pa, PSYM=-5, TITLE='NGC2974 velocity', xtickformat = '(A1)', YTITLE='!7C!X!N [degrees]', YRANGE=[30,70]
